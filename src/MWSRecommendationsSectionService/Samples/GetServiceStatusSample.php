 ...
 ***********************************************************************/
// @TODO: set request. Action can be passed as MWSRecommendationsSectionService_Model_GetServiceStatus
$request = new MWSRecommendationsSectionService_Model_GetServiceStatusRequest();
 ...
 * @param mixed $request MWSRecommendationsSectionService_Model_GetServiceStatus or array of parameters
 */

function invokeGetServiceStatus(MWSRecommendationsSectionService_Interface $service, $request)
{
    try {
